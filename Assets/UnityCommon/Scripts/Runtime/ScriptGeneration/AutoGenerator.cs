...
namespace UnityCommon.ScriptGeneration
{
	...
	public static class AutoGenerator
	{
		...
		private static void OnScriptsReloaded()
		{
			...
			foreach (var assembly in System.AppDomain.CurrentDomain.GetAssemblies())
			{
				...
				foreach (var type in assembly.GetTypes())
				{
					...
					var atts = type.GetCustomAttributes(typeof(AutoGenerateAttribute), false);
					...
					if (atts.Length > 0)
					{
						...
						var att = ((AutoGenerateAttribute)atts[0]);
		...
		private static void GenerateClasses(string rootDir, string typeNameFormat, string ns, string baseType, string[] args)
		{
...
public class {typeName} : {baseType}<{arg}> {{}}
		...
		private static void GenerateClassesMerged(string rootDir, string typeNameFormat, string ns, string baseType, string[] args)
		{
